function main(ac_nonce) {
    ...
    not_null = function (){v_log('__arg__：',...arguments)};
    window = global;
    ...
    window.RegExp = function () {
        console.log("window.RegExp  参数为：",arguments)
        return arguments[0]
    }

    // window.Object = function (params) {
    //     console.log("window.Object",arguments)
    // }

    window.sessionStorage = {
        // BackURl: "\"/user/MS4wLjABAAAAx-mH1oMVAHDSCU4YM-_AnJyAK7wYYxYQeGniL_dmZw4BBbkZ-rLoRxon6WTbjrRd\"",
        // msToken: "Hza5MPdjLTBDB_3ZAi5Jf0CljQZiniKqBOqaQZmF3zCENvaIsorBsQB774VVdnohtf_sLdXINjjxScxJLxQMizoStYZYmgujJb8Di4SftZ6G-cmzRY646yD-I64C",
        // route_params: "{}",
        // tt_scid: "3xK4W8oW.x39iccx9TP91-NDxZE.85y3i1C4VlMTB89ID7eAR7xWkUK9hea1AnqCd1b5",
        // __ac_ns: "1711239586279",
        __tea_session_id_6383: "{\"sessionId\":\"1e9a5e6f-2332-471a-a0eb-88d54bb72267\",\"timestamp\":1711241296040}"
    }
    window.__ff = []
    ...
    document.createElement = function (params) {
        console.log("document.createElement  参数为：",params)
        if (params == "canvas"){
            return {}
        }
    }
    document.createEvent = function () {
        console.log("document.createEvent  参数为：",arguments)
    }
    location = {
        ancestorOrigins:{length:0},
        assign:function (params) {
            console.log("lovation.assign中的参数:",params)
        },
        hash: "",
        host: "www.douyin.com",
        hostname: "www.douyin.com",
        href: "https://www.douyin.com/user/MS4wLjABAAAAx-mH1oMVAHDSCU4YM-_AnJyAK7wYYxYQeGniL_dmZw4BBbkZ-rLoRxon6WTbjrRd",
        origin: "https://www.douyin.com",
        pathname: "/user/MS4wLjABAAAAx-mH1oMVAHDSCU4YM-_AnJyAK7wYYxYQeGniL_dmZw4BBbkZ-rLoRxon6WTbjrRd",
        port: "",
        protocol: "https:"
    }
    ...
    for (var item of window.__ff){
        if (item.c == 29814){
            return item("", ac_nonce)
        }
    }
    document.cookie = '__ac_nonce='+ac_nonce

}

console.log(main("065ffa4110056241b8466"));
