...
if __name__ == '__main__':
    y = YdmVerify()
    backImage = open('backImage.png','rb').read()
    slidingImage = open('slidingImage.png','rb').read()
    y.slide_verify(slide_image=slidingImage,background_image=backImage,verify_type="20111")
